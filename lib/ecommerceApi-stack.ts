...
export class ECommerceStack extends cdk.Stack {
   ...
   constructor(scope: Construct, id: string, props: ECommerceStackProps) {
      ...
      const logGroup = new cwlogs.LogGroup(this, "ECommerceLogs")
      const api = new apigateway.RestApi(this, "ECommerce", {
         restApiName: "ECommerce",
         deployOptions: {
   ...
   private createCognitoAuth() {
      ...
      this.customerPool.addDomain("CustomerDomain", {
         cognitoDomain: {
            domainPrefix: "customer-service"
         }
      })

      this.adminPool.addDomain("AdminDomain", {
         cognitoDomain: {
            domainPrefix: "admin-service"
         }
      })
   ...
   private createOrdersService(props: ECommerceStackProps, api: apigateway.RestApi) {
      ...
      //GET /orders
      //GET /orders?email=helmifran@gmail.com
      //GET /orders?email=helmifran@gmail.com&orderId=123
      ...
      //DELETE /orders?email=helmifran@gmail.com&orderId=123
      ...
      //GET /orders/events?email=helmifran@gmail.com
      //GET /orders/events?email=helmifran@gmail.com&eventType=ORDER_CREATED
